...
def main():
    ...
    random_forest = RandomForest(
        X_trainval_clean, y_trainval_clean, X_test_clean, y_test_clean
    )
    ...
    print(
        f"SVM Results: {svm_results}, Random Forest Results: {random_forest_results}, XGBoost Results: {xgboost_results}"
    )
