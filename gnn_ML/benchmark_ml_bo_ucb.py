#!/usr/bin/env python3
"""
BO/UCB benchmark for tabular molecular-property surrogates.
...
Example:
python benchmark_ml_bo_ucb.py --dataset ESOL --model xgb --acquisition ucb
"""
...
def main() -> None:
    ...
    parser.add_argument("--model", choices=["rf", "hgb", "xgb"], default="rf")
